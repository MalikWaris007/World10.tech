  ...
  return (
    <div className="heroSection bg-[#151423] mb-12 flex justify-around gap-2 py-[80px] overflow-hidden">
      <div className="w-[48%]">
        ...
        <h1 className="text-[#ff6a00] text-[75px] font-bold leading-[90px] font-[Rajdhani,sans-serif]">Creating a better IT solutions</h1>
        <p className="text-[23px] text-white font-semibold pb-8 pt-4 font-[Robik,sans-serif]">Dcidunt eget semper nec quam. Sed hendrerit morbi ac felis. Nunc egestas augue pellentesque</p>
